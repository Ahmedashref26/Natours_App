...
},{"./alerts.js":"alerts.js","axios":"../../node_modules/axios/index.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWhtZWQyMTIiLCJhIjoiY2wxanh2YmtqMGUwYjNrazF3eDc4eGozYyJ9.lAn4L7HzCGDgAPiiDIjaBg';
  ...
  locations.map(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends bounds to include current location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              window.setTimeout((0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")), 1500);
            }
...
var stripe = Stripe('pk_test_51Kmp9iIhcdN95CBz3W8ML1K9fa5L4vnAqO3uTKsfUHiJbxZcY9KdGKTfGD98DUuoszr9zdpnbKapIasRtBVVSRBA008YGcdZ9p');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session);
            window.location.replace(session.data.session.url); // await stripe.redirectToCheckout({
